...
class _SignUpState extends State<SignUp> {
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          ...
                          if (formkey.currentState!.validate()) {
                            if (otpst) {
                              Flutter_api().register(email.text, storeName.text,
  ...
  void setLoaction() async {
    ...
    Null latitude = position.latitude;
    Null longitude = position.longitude;

    storeLocationLong.text = "$latitude,$longitude";
  }
}

extension on Position {
  Null get latitude => null;

  Null get longitude => null;
}
